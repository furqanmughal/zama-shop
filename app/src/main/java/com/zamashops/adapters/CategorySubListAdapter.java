...
import com.zamashops.activities.AllProductActivity;
import com.zamashops.models.CategoryModel;

import java.util.ArrayList;

public class CategorySubListAdapter extends RecyclerView.Adapter<CategorySubListAdapter.CategoryListViewHolder> {

    Context context;
    ArrayList<CategoryModel> items;

    public CategorySubListAdapter(Context context, ArrayList<CategoryModel> items) {
    ...
    public CategoryListViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new CategorySubListAdapter.CategoryListViewHolder(view);
    }
