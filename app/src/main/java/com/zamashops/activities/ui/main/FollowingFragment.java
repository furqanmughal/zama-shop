...
public class FollowingFragment extends Fragment {
    ...
    public static FollowingFragment newInstance(String post_user_id) {
    ...
    void selectData(final int limit) {
        ...
        CustomVolley.getInsertPOSTData2(getActivity(), params, "user/fetch_following_user.php", new VolleyCallback() {
            @Override
