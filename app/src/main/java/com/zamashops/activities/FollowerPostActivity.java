...
public class FollowerPostActivity extends AppCompatActivity {
    ...
    Context context = FollowerPostActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_follower_post);
        ...
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(list_post.getContext(),
                linearLayoutManager.getOrientation());
        list_post.addItemDecoration(dividerItemDecoration);
    ...
    void selectData() {
        ...
        CustomVolley.getInsertPOSTData3(context, params, "fetch_follower_post.php", new VolleyCallback() {
            @Override
